...
public class PercolationTestRunner {
	...
	public static void main(String[] args) {
		String directory = "Z:/Supratim/Dev Work/Personal/CourseraAlgos/Algorithms/ProgrammingAssignments/tests/percolation/testdata";
		...
		for (File file : files) {
			...
			String percolationResult = percolation.percolates() ? "PERCOLATES"
					: "DOES NOT PERCOLATE";
